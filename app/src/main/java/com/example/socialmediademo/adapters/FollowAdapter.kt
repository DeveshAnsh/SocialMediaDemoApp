...
import com.example.socialmediademo.databinding.FollowRvBinding
...
return followList.size
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        Glide.with(context).load(followList.get(position).image).placeholder(R.drawable.user).into(holder.binding.imageView2)
