...
import com.example.socialmediademo.databinding.ReelDgBinding
...
class ReelAdapter(var context: Context, var reelList: ArrayList<Reel>) :
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        Picasso.get().load(reelList.get(position).profileLink).placeholder(R.drawable.user).into(holder.binding.profileImage2)
